...
public class AppGlobalExceptionHandler {
	...
	@ExceptionHandler(ExcelExceptionHandler.class)
	public ModelAndView handleException(ExcelExceptionHandler exc, HttpServletRequest req) {
		LOGGER.error("Exception : " + exc);
